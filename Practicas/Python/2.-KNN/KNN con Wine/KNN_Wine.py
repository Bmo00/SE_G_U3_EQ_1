...
archivo = open("XWine_Training.csv","r")
...
instancia = [ [ list(map(float,x[:13])), x[13] ] for x in lista ] #pokemones
...
prueba = [ [ list(map(float,x[:13])), x[13] ] for x in lista ] #pokemones
