...
archivo = open("XIris_Training.txt")
...
Clases = ["I. Setosa", "I. Varicolor", "I. Virginica"]
...
# si ya tienes algo del de Ehivy, simplemente es lo mismo, solo se tuvo que cambiar al principio en los maps de Int a
# Float, y en las clases los valores de las clases
