...
archivo = open("XPokemones_TrainingSinEWB.csv", "r")
...
instancia = [ [ list(map(float,x[:5])), x[5] ] for x in lista ] #pokemones
...
archivo = open("YResultadoTest.csv", "r")
contenido = archivo.readlines()
...
prueba = [ [ list(map(float,x[:5])), x[5] ] for x in lista ] #pokemones
...
Res=str(contAciertos/len(prueba)*100)
print("Rendimiento: " + Res)
