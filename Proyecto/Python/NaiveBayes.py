print("\nCALCULANDO CON NAIVE BAYES...")

file2read = open("ZPTraining_Discretizado.csv")
...
## TESTING
#############################################################################################
file2read = open("ZPTest_DiscretizadoCE.csv")
file_content = file2read.readlines()
#############################################################################################
dataset = []
for i in file_content:
...
Res=round(correct_classify/len(dataset)*100,4)
print("\n\nCorrect Classify: " , correct_classify, " Total Evaluated: " , len(dataset), " Efficiency: ",Res,"%")
