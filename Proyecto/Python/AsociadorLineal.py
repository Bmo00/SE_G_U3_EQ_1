...
print("\nCALCULANDO CON ASOCIADOR LINEAL...")
archivo = open("YPokemones_TrainingInvertido.txt")
...
#################################################################################################
print("Prueba...")
archivo = open("YResultadoTestInvertido.txt")
contenido = archivo.readlines()
...
Res=casosCorrectos/X.shape[1]*100.0
print("Eficiencia del Asociador Lineal: ",Res)
